...
class QDSHandlerBob():
    ...
    async def handle_key_transfer(self, request):
        ...
        print(f"Number of Charlie's bits received: {sum([len(block) for block in self.Charlie_half])}")
    ...
    async def handle_verification(self, request):
        ...
        print("Verification completed without errors detected.")
        return True
    ...
    async def dispatcher(self, reader, writer):
        ...
        if request["type"] == "QKD":
            ...
            if verification == False:
                ...
                print("Verification Failed. Transmitting response to Alice. Signatures not forwarded to Charlie.")
                ...
                print("Verification Successful. Transmitting response to Alice.")
                ...
                print("Forwarding Signatures to Charlie. Awaiting Response.")
